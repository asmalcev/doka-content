...
**Кривые Безье** позволяют рисовать плавные линии. Для описания кривой требуется всего несколько координат точек. Первая и последняя точки будут началом и концом кривой, а промежуточные будут влиять на её изгиб. «[Кривые Безье](https://learn.javascript.ru/bezier-curve)».
...
Числа в описании пути могут быть разделены пробелами, табуляцией, переносами строк или запятыми, причем нет ограничений в каких ситуациях запятую можно, а в каких нет. Результат будет одинаковый:
...
Подробнее о грамматике описания пути в [официальной спецификации SVG](https://svgwg.org/svg2-draft/paths.html#PathDataBNF).
